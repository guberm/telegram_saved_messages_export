@echo off
:: Create Desktop Icon - Simple version
:: Double-click this file to create desktop shortcut
...
:: Target - use START_HERE.bat which handles Python detection
set "TARGET=%SCRIPT_DIR%\START_HERE.bat"

if not exist "%TARGET%" (
    echo [ERROR] START_HERE.bat not found!
